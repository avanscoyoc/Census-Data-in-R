...
- Use packages to fetch decennial and ACS census data
- Use packages to fetch census geograpic boundary files
...
Bring a laptop with R, RStudio and the following R packages installed: `sp`, `sf`, `rgdal`, `rgeos`, `raster`, `ggplot2`, `tmap`, `tigris` and `tidycensus`.
