...
census_api_key("THE_BIG_LONG_ALPHANUMERIC_API_KEY_YOU_GOT_FROM_CENSUS", install = TRUE)
```

## Install your Census API Key

Alternatively, I keep my key in a file so no one can see it
```{r}
...
### Error in gather.default(., key = variable, value = value, -GEOID, -NAME) : object 'NAME' not found
```
